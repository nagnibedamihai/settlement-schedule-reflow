...
import {
  checkChannelOverlaps,
  checkDependencies,
  checkBlackoutWindows,
  checkRegulatoryHolds,
  validateSchedule,
} from '../src/reflow/constraint-checker.js';
import type { SettlementTask, SettlementChannel } from '../src/reflow/types.js';

function makeTask(overrides: Partial<SettlementTask['data']> & { docId?: string }): SettlementTask {
...
function makeChannel(): SettlementChannel {
  return {
    docId: 'ch-1',
